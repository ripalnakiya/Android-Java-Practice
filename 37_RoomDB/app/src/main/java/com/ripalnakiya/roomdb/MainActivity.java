...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbManager = DatabaseManager.getDatabaseManager(this);

        if (dbManager.contactDao().fetchContacts() != null) {
            setResult();
        }
    }
    ...
    void setResult() {
        ArrayList<Contact> arrContacts = (ArrayList<Contact>) dbManager.contactDao().fetchContacts();
